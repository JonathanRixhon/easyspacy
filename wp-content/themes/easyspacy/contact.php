...
<main class="main-contact">
    <h2 class="main-contact__title">Nous contacter</h2>
    <section class="dialog-part">
        <h3 class="dialog-part__title sro">Instructions</h3>
        <p class="dialog-part__text">Test</p>
        <p class="dialog-part__text">Test</p>
    </section>
